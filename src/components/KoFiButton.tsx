      ...
      >
        {open && (
          <div
            style={{
              boxShadow:
                "0 8px 30px 10px rgb(0 0 0 / 25%), 0 2px 10px rgb(0 0 0 / 25%)",
              backgroundColor: "#fff",
              borderRadius: 8,
          ...
          >
            <iframe
              title="iframe ko-fi"
              src={
                endpoint + username + "/?hidefeed=true&widget=true&embed=true"
              }
              style={{
                width: 328,
            ...
            >
              <a href={endpoint + username} target="_blank" rel="noreferrer">
                {endpoint + username}
              </a>
            </div>
          </div>
